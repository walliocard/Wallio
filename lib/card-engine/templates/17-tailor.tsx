...
const template: CardTemplate = {
  ...
  render({ data, tokens, thumbnail, dimensions, strip }) {
    ...
    if (strip) return renderStrip(data, tokens, {
      decoratives: (
        <>
          <div style={{ position: "absolute", inset: 5, border: `0.5px solid ${tokens.borderStrong}`, opacity: 0.4, pointerEvents: "none" }}/>
          <div style={{ position: "absolute", inset: 9, border: `0.5px solid ${tokens.border}`, opacity: 0.3, pointerEvents: "none" }}/>
        </>
      ),
    });
        ...
        <div style={{
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{
              ...
              border: `1px solid ${tokens.accent}22`, display: "flex", alignItems: "center", justifyContent: "center", marginTop: 3,
            }}>
