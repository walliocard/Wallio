...
const template: CardTemplate = {
  ...
  render({ data, tokens, thumbnail, dimensions, strip }) {
    ...
    if (strip) return renderStrip(data, tokens, {
      decoratives: (
        <>
          <svg style={{ position: "absolute", right: "-20%", top: "-30%", opacity: 0.1, pointerEvents: "none" }} width={150} height={150} viewBox="0 0 150 150" fill="none">
            <path d="M75 10 C110 5 145 35 140 75 C135 115 100 140 65 138 C30 136 5 105 8 68 C11 31 40 15 75 10Z" fill={tokens.accent}/>
          </svg>
          <svg style={{ position: "absolute", left: "-15%", bottom: "8%", opacity: 0.08, pointerEvents: "none" }} width={90} height={90} viewBox="0 0 90 90" fill="none">
