...
const template: CardTemplate = {
  ...
  render({ data, tokens, thumbnail, dimensions, strip }) {
    ...
    if (strip) return renderStrip(data, tokens, {
      decoratives: (
        <div style={{ position: "absolute", right: "-3%", bottom: "-8%", fontSize: 90, fontWeight: 900, color: tokens.surface, lineHeight: 1, userSelect: "none", letterSpacing: -5, pointerEvents: "none" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            border: `1px solid ${tokens.accent}20`, flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center",
          }}>
