...
const template: CardTemplate = {
  ...
  render({ data, tokens, thumbnail, dimensions, strip }) {
    ...
    if (strip) return renderStrip(data, tokens, {
      decoratives: (
        <div style={{ position: "absolute", right: "5%", top: "50%", transform: "translateY(-50%) rotate(-8deg)", width: 65, height: 65, borderRadius: "50%", border: `3px solid ${tokens.accent}`, opacity: 0.06, pointerEvents: "none" }}/>
      ),
    });
