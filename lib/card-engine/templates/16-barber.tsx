...
const template: CardTemplate = {
  ...
  render({ data, tokens, thumbnail, dimensions, strip }) {
    ...
    if (strip) return renderStrip(data, tokens, {
      decoratives: (
        <>
          <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: logoSz, background: tokens.accent }}/>
          <div style={{ position: "absolute", top: "20%", left: 0, right: 0, height: "0.5px", background: tokens.border, opacity: 0.3 }}/>
          <div style={{ position: "absolute", top: "50%", left: 0, right: 0, height: "0.5px", background: tokens.border, opacity: 0.3 }}/>
        </>
      ),
    });
