...
const template: CardTemplate = {
  ...
  render({ data, tokens, thumbnail, dimensions, strip }) {
    ...
    if (strip) return renderStrip(data, tokens, {
      decoratives: (
        <>
          <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", width: 300, height: 300, borderRadius: "50%", border: `1px solid ${tokens.border}`, opacity: 0.4 }}/>
          <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", width: 45, height: 45, borderRadius: "50%", background: tokens.border, opacity: 0.15 }}/>
        </>
      ),
    });
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            border: `1px solid ${tokens.accent}18`, flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center",
          }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                <span style={{ fontSize: thumbnail ? 5 : ss(10), fontWeight: 600, lineHeight: 1, color: tokens.accent }}>
