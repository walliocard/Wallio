...
export async function POST(req: Request) {
  ...
  // Whitelist des champs autorisés — jamais de champs sensibles (actif, nfc_id)
  const allowed = [
    "logo_url", "strip_url",
  ...
  await adminDb().collection("marchands").doc(uid).update(data);
